...
<!--                        </div>	-->
        ...
        <div id="sidebar">
        	<h3 id="catTitle">Категории</h3>
            <ul class="sidebar_menu">
			    <li><a id="hairdresser" class="categoryLink" onclick="javascript:changeContent('0')">Aenean et dolor diam</a></li>
                <li><a id="napkinsTowels" class="categoryLink" onclick="javascript:changeContent('2081529768')">Aenean pulvinar</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('334170685')">Cras bibendum auctor</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('1027010937')">Donec sodales bibendum</a></li>
            	<li><a class="categoryLink" onclick="javascript:changeContent('1882604320')">Etiam in tellus</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('1906864609')">Hendrerit justo</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('1087128356')">Integer interdum</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('1118201728')">Maecenas a diam</a></li>
				<li><a class="categoryLink" onclick="javascript:changeContent('1654510439')">Nullam in semper</a></li>
				<li><a class="categoryLink" onclick="javascript:changeContent('743433958')">Posuere in commodo</a></li>
				<li><a class="categoryLink" onclick="javascript:changeContent('1192337617')">Tincidunt leo</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('1852602572')">Vestibulum blandit</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('1146572200')">Vestibulum blandit</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('789329404')">Vestibulum blandit</a></li>
                <li><a class="categoryLink" onclick="javascript:changeContent('323779058')">Vestibulum blandit</a></li>
